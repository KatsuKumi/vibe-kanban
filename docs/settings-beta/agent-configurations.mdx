...
<Tab title="CLAUDE_CODE">
  ...
  <ParamField path="thinking_budget" type="integer">
  Maximum thinking tokens for extended thinking mode. When set, enables the model to use a reasoning process before responding, improving quality on complex tasks.
  </ParamField>
